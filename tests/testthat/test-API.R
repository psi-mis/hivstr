...
test_that("API endpoint defautls to hotspots", {
  expect_equal(api_endpoint(), paste0("https://clone.psi-mis.org/", api_resource("dataValueSet.json"),"?dimension=dx:dQTWxMDtAiW;mOGarPwHuFc;JKSFbYxvXDn&dimension=n5ODfcdD1YQ:YF8v2OSxWKl&dimension=ou:rP1W74RpNWF&dimension=pe:THIS_MONTH&completedOnly=false"))
})
